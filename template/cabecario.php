        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-8 col-md-7 py-4">
              ...
              <p class="text-white">
                Aplicação para auxiliar na tarefa de gerenciar jogos de futebol, gerenciando seus estadios, times, jogadores e suas partidas.
              </p>
            </div>
            <div class="col-sm-4 offset-md-1 py-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="<?= BASE_URL; ?>/jogador/jogador.php" class="text-white">Jogadores</a></li>
                <li><a href="<?= BASE_URL; ?>/time/time.php" class="text-white">Times</a></li>
                <li><a href="<?= BASE_URL; ?>/estadio/estadio.php" class="text-white">Estadios</a></li>
                <li><a href="<?= BASE_URL; ?>/jogo/jogo.php" class="text-white">Jogos</a></li>
